...
plt.figure(figsize=(10,6))
plt.scatter(df['peak1_area_W_Hz'], power, label='Peak 1 Area')
plt.scatter(df['peak2_area_W_Hz'], power, label='Peak 2 Area')
plt.scatter(df['peak3_area_W_Hz'], power, label='Peak 3 Area')
plt.ylabel('Power of 10% Beam Splitter (MicroWatt)')
...
plt.figure(figsize=(10,6))
plt.scatter(power, df['peak1_area_W_Hz'], label='Peak 1 Area')
plt.scatter(power, df['peak2_area_W_Hz'], label='Peak 2 Area')
plt.scatter(power, df['peak3_area_W_Hz'], label='Peak 3 Area')
plt.xlabel('Power of 10% Beam Splitter (MicroWatt)')
